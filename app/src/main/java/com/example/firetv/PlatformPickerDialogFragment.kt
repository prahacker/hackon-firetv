    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        platforms.forEach { platform ->
            val imageView = ImageView(requireContext()).apply {
                ...
                when {
                    normalized.contains("netflix") -> setImageResource(R.drawable.netflix_logo)
                    normalized.contains("prime") || normalized.contains("amazon") -> setImageResource(R.drawable.prime_logo)
